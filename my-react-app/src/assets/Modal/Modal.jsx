...
const Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <>
    <div className="modal show" id="addItemModal" tabIndex="-1" aria-labelledby="addItemModalLabel" aria-hidden="false">
    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
        <div className="upload-area mb-3">
          ...
          <div className="upload-hint">Drag and drop or click to browse. Max 5MB, JPG/PNG only.</div>
        </div>
      ...
      <div className="modal-footer">
        <button type="button" className="btn-discard" onClick={onClose}>Discard Draft</button>
